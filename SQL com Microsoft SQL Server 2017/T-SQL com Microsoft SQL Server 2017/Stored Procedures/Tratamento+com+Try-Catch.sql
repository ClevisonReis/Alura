...
CREATE PROCEDURE InclusaoVendedorTry
@MATRICULA AS VARCHAR(5), @NOME AS VARCHAR(100), @PERCENTUAL AS FLOAT, 
@DATAADMISSAO AS DATE, @FERIAS AS BIT, @BAIRRO AS VARCHAR(50), @MENSAGEM VARCHAR(100) OUTPUT
...
DECLARE @MENSAGEM VARCHAR(30)
EXEC InclusaoVendedorTry '00241', 'Pericles Alves', 0.11, '20160821', 0, 'Santo Amaro', @MENSAGEM = @MENSAGEM OUTPUT
IF @MENSAGEM <> ''
    PRINT @MENSAGEM
